package com.imastudio.costumerappojol.adapter;
...
import com.imastudio.costumerappojol.view.activity.DetailOrderActivity;
...
public class CustomHistoryAdapter extends RecyclerView.Adapter
        <CustomHistoryAdapter.ViewHolder> {
